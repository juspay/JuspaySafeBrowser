#
#  Be sure to run `pod spec lint JuspaySafeBrowser.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    The library provides various convenience and security features for users to be able to complete the transaction quickly. 
  ...
  # Or just: s.author    = "Sachin Sharma"
  # s.authors            = { "Sachin Sharma" => "sachin.sharma@juspay.in" }
  # s.social_media_url   = "http://twitter.com/Sachin Sharma"
